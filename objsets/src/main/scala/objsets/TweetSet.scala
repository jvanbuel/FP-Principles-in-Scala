...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def mostRetweeted: Tweet = {
    def max_Ret(Tweet1: Tweet, Tweet2: Tweet): Tweet = {
      if (Tweet1.retweets > Tweet2.retweets) Tweet1 else Tweet2
    }
    if (left.isEmpty  && right.isEmpty) elem
    else if (right.isEmpty) max_Ret(left.mostRetweeted, elem)
    else if (left.isEmpty) max_Ret(right.mostRetweeted, elem)
    else max_Ret(left.mostRetweeted, max_Ret(right.mostRetweeted, elem))
    }
